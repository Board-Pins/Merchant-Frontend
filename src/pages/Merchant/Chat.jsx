...
import Chatheader from '../../components/merchant/Chat/Chatheader';
import Chatsidebar from '../../components/merchant/Chat/Chatsidebar';
import InputMessage from '../../components/merchant/atoms/atomsChat/atomsChatMain/InputMessage';
  ...
  return (
    <div className='bg-white rounded-xl p-5 font-poppins'>
      ...
      <div className='  lg:flex-row flex flex-col lg:min-h-[60vh] gap-6 mt-5 md:mx-12 mx-5 overflow-hidden'>
        <div
          className={`fixed top-0 left-0 z-50 w-64 lg:min-h-[75vh] bg-white shadow-lg transition-transform transform ${isSidebarOpen ? 'translate-x-0 h-full' : '-translate-x-full h-full'
